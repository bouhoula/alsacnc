...
class CommandSequence:
    ...
    def browse(self, num_links: int = 2, sleep: int = 0, timeout: int = 60) -> None:
    ...
    def save_screenshot(self, suffix: str = "", timeout: int = 30) -> None:
    ...
    def screenshot_full_page(self, suffix: str = "", timeout: int = 30) -> None:
    ...
    def dump_page_source(self, suffix: str = "", timeout: int = 30) -> None:
    ...
    def recursive_dump_page_source(self, suffix: str = "", timeout: int = 30) -> None:
